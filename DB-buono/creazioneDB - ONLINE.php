...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
       ...
       <?php			
        ...
        $mysqliConnection = new mysqli("localhost", "lweb6", "lweb6");

        if (mysqli_connect_errno()) {
            printf("Connessione al DB non riuscita. Errore: %s\n", mysqli_connect_error());
                }

 
        
        $mysqliConnection = new mysqli("localhost", "lweb6", "lweb6", $db_nome);
