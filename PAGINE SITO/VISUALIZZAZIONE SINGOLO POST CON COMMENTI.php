...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <head>
    <PHP> <link rel="stylesheet" type="text/css" href="CSS/MENUPROVA.css"> <PHP>
                ...
                <div class="leftcolumnwidget">
                    ...
                    <div class="central-column">
                        <div class="postscolumnwidgettop">
                            <img class="popolareIMG" src="./IMMAGINI/postCommenti.png">
                        </div>
                            <div class="postscolumnwidgetbody">
                                <div class="card">  
                                    <?php
                                    
                                        include("../visualizzazioneSingoloPostConCommBOTTONI.php");
