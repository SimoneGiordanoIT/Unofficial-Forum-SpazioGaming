        ...
        <div id="main_page" class="main_page">
            ...
            <div class="contentwrapper">
                        ...
                        <div class="leftcolumnwidgettop">
                            ...
                            if(isset($_SESSION['ruolo']) && $_SESSION['ruolo'] == 1 ){
                                ...
                                echo"<div class='vertical_menu'>
                                            <form  action='../CreazioneMessaggioUtente-Mod.php'>
                                            
                                            <button>CHIEDI ALL'ADMIN DI AGGIUNGERE UN GIOCO</button>
                                            </form>
                            </div>
                    ...
                    <div class="central-column">
                        ...
                        <img class="popolareIMG" src="./IMMAGINI/notifiche.png">
                        </div>
                            <div class="postscolumnwidgetbody">
                            
                                <?php
                                if($_SESSION['ruolo']==100){
                                    include("../VisualizzazioneMessaggiADMIN-UT DI ADMIN.php");
                                }else{
                                    include("../VisualizzaNotificheDaParteUtente.php");
                                }
